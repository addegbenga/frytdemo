...
import GooglePlace from '@components/ui/GooglePlaces';
...
const Ship_loose_step_3: React.FC<IStepTwoProps> = ({ ...props }) => {
  ...
  return (
    <div className="w-1/2 p-5 overflow-x-hidden bg-white border border-t-4 rounded-md shadow-md border-t-accent-1 h-fit ">
      ...
      <div>
        <p className="text-xs text-secondary">Step 3/5</p>
      ...
      <section>
        <div className="flex items-center mt-10">
          <h1 className=" text-[#304157]">Shipping Address Information</h1>
        </div>
...
export default Ship_loose_step_3;
